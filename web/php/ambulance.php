            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        <h2 class="pull-left">Ambulance List</h2>
                    </div>
                    <div class="row">
                        <?php
                        require_once "C:/xampp/htdocs/web/php/databse.php";
                        
                        $sql = "SELECT ambulance_name,phone_number,city from ambulance";
                        if($result = mysqli_query($con, $sql)){
                            while($row = mysqli_fetch_array($result)){
                                echo '<div class="col-md-4">';
                                echo '<div class="card">';
                                echo '<div class="card-body">';
                                echo '<p class="card-text">Ambulance Name: ' . $row['ambulance_name'] . '</p>';
