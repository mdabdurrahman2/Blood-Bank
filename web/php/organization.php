            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        <h2 class="pull-left">Organization List</h2>
                    </div>
                    <div class="row">
                        <?php
                        require_once "C:/xampp/htdocs/web/php/databse.php";
                        
                        $sql = "SELECT organization_name,phone_number,city from organization";
                        if($result = mysqli_query($con, $sql)){
                            while($row = mysqli_fetch_array($result)){
                                echo '<div class="col-md-4">';
                                echo '<div class="card">';
                                echo '<div class="card-body">';
                                echo '<p class="card-text">Organization Name: ' . $row['organization_name'] . '</p>';
