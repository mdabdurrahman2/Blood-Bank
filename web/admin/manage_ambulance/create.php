...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($input_ambulance_name)){
        ...
        $abulance_name_err = "Please enter a valid name.";
    } else{
...
<body>
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="mt-5">Create Record of Ambulances</h2>
                    <p>Please fill this form and submit to add ambulance record to the database.</p>
