...
if(isset($_POST["donor_id"]) && !empty($_POST["donor_id"])){
    ...
    $sql = "DELETE FROM signup_info WHERE donor_id = ?";
    
    if($stmt = mysqli_prepare($link, $sql)){
        mysqli_stmt_bind_param($stmt, "i", $param_donor_id);
        
        $param_donor_id = trim($_POST["donor_id"]);
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger">
                            <input type="hidden" name="donor_id" value="<?php echo trim($_GET["donor_id"]); ?>"/>
